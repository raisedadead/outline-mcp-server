...
function extractStringParam(params, key) {
...
export function registerResources(server, client) {
    ...
    server.registerResource('collections', 'outline://collections', {
    ...
    server.registerResource('collection', new ResourceTemplate('outline://collections/{collectionId}', {
        list: async () => {
            const collections = await client.listCollections();
            return {
    ...
    server.registerResource('document', new ResourceTemplate('outline://documents/{documentId}', {
        list: async () => {
